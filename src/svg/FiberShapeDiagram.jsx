...
function FiberShapeDiagram() {
  return (
    ...
    >
      ...
      <rect x="20" y="20" width="170" height="120" fill="none" stroke="var(--color-text)" strokeWidth="1" />
      <path d="M50,80 Q120,70 155,80 Q165,82 165,80 Q165,78 155,80" fill="none" stroke="var(--color-accent-solid)" strokeWidth="2.5" />
      <circle cx="164" cy="80" r="4" fill="none" stroke="var(--color-accent-solid)" strokeWidth="2" />
      <text x="105" y="155" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="11" fill="var(--color-text)">
        kōzo — rounded tip
      </text>

      <rect x="230" y="20" width="170" height="120" fill="none" stroke="var(--color-text)" strokeWidth="1" />
      <path
        ...
        strokeWidth="2"
      />
      <text x="315" y="155" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="11" fill="var(--color-text)">
